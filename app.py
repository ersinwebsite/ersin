...
<head>
    ...
    <style>
        * {
        ...
        .btn-circle img, .slider-wrapper img {
            pointer-events: none;
            user-select: none;
        }
    </style>
        ...
        <div id="measure-container">
            ...
            <div class="calibration-card">
                ...
                <div class="slider-wrapper">
                    <!-- EVRENSEL TABANLI BASE64 EKSİ (-) İKONU -->
                    <img src="data:image/svg+xml;base64," style="width: 20px; height: 20px;" alt="Minus" />
                    
                    <input type="range" id="calibration-slider" min="100" max="600" value="300" class="modern-slider">
                    
                    <!-- EVRENSEL TABANLI BASE64 ARTI (+) İKONU -->
                    <img src="data:image/svg+xml;base64," style="width: 20px; height: 20px;" alt="Plus" />
                </div>
            </div>
            ...
            <div class="action-overlay">
                ...
                <button class="btn-circle" id="back-to-cam" title="Geri Dön">
                    <!-- ARKA PLANA GÖMÜLÜ BEYAZ GERİ OK SİMGESİ (BASE64) -->
                    <img src="data:image/svg+xml;base64," style="width: 28px; height: 28px; display: block;" alt="Geri Dön" />
                </button>
                <!-- KAYDET BUTONU -->
                <button class="btn-circle success" id="save-btn" title="Kaydet">
                    <!-- ARKA PLANA GÖMÜLÜ SİYAH KAYDET (FLOPPY) SİMGESİ (BASE64) -->
                    <img src="data:image/svg+xml;base64," style="width: 26px; height: 26px; display: block;" alt="Kaydet" />
                </button>
            </div>
        </div>
    </div>
